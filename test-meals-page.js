// Test script to verify meals page loads properly
// Run this in the browser console after navigating to the meals page

console.log('🧪 Testing Meals Page Load...')
...
setTimeout(() => {
  ...
  if (window.location.pathname.includes('/meals')) {
    ...
    // Test the meals data
    if (window.mealsData) {
      console.log('📊 Meals data available:', window.mealsData.length, 'items')
      console.log('📊 Sample meal:', window.mealsData[0])
    }
    ...
    if (errorMessages.length > 0) {
      ...
      console.log('⚠️ No table data found - may need to add meals')
    }
  } else {
    console.log('❌ Not on meals page - navigate to /meals first')
  }
}, 2000)
